...
const IncomeTaxCalForm2324 = () =>
{
  ...
  useEffect( () =>
  {
    ...
    axios
      .post( api + `/admin/income-tax/filling-yr-2324-data-get`,
        {
  ...
  const handleSubmit = () =>
  {
    ...
    if ( myOldTaxableIncome > 0 && myNewTaxableIncome > 0 )
    {
      ...
      axios
        .post( api + `/admin/income-tax/filling-yr-2324-save-data`,
          {
...
export default IncomeTaxCalForm2324;