...
const IncomeTaxUserList = () =>
{
    ...
    useEffect( () =>
    {
        ...
        axios
            .post( api + `/admin/income-tax/all-users`,
                {
    ...
    const handleFile2324 = ( userId ) =>
    {
        // navigate( '/income-tax/service-list/' + userId );


        axios
            .post( api + `/admin/income-tax/filling-yr-2324`,
                {
            ...
            .then( response =>
            {
                ...
                if ( response.data.status == 1 )
                {
                    ...
                    console.log( myData );
                    // setUsers( myData );
                    window.open( `${ import.meta.env.BASE_URL }income-tax/23-24/${ myData.formId }/${ myData.serviceId }`, "_blank" ) //to open new page
                } else
                {
                    alert( response.data.message );
                }
                                                ...
                                                <Fragment key={ user._id }>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button
                                                                onClick={ () => handleFile2324( user.userFullData.userId ) }
                                                                type="button"
...
export default IncomeTaxUserList;
