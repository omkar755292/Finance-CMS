...
const InsuranceServiceList = () =>
{
    ...
    const handleAddService = () =>
    {
        ...
        navigate( `/insurance/service/${ userId }/new-insurance` );
    };
    ...
    useEffect( () =>
    {
        ...
        axios
            .post( api + `/admin/insurance/all-services`,
                {
    ...
    const handleInsuranceClaim = serviceId =>
    {
        // useNavigate to another page
    ...
    const handleInsuranceCustomFiles = serviceId =>
    {
        // useNavigate to another page
        navigate( `/insurance/service/${ userId }/${ serviceId }/support-documents` );
                                                ...
                                                { services.map( service => (
                                                    <Fragment key={ service._id }>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{ service.insuranceName }</td>
                                                            <td>{ service.insuranceType }</td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button
                                                                    ...
                                                                    type='button'
                                                                    onClick={ () => handleInsuranceCustomFiles( service.serviceId ) }
                                                                >
                                                                    Custom Files
                                                                </button>
                                                                ...
                                                                <button
                                                                    ...
                                                                    className='ti-btn ti-btn-danger me-1'
                                                                    type='button'
                                                                    onClick={ () => handleInsuranceClaim( service.serviceId ) }
                                                                >
                                                                    Claim Insurance
                                                                </button>
