...
const SIPUserList = () =>
{
    ...
    const handleNewSIP = ( userId ) =>
    {
        navigate( '/sip/new-sip-investment/' + userId );
    };

    const handleAllSIP = ( userId ) =>
    {
        navigate( '/sip/user-sip-investment/' + userId );
    };
                                                ...
                                                <Fragment key={ user._id }>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button
                                                                onClick={ () => handleNewSIP( user.userFullData.userId ) }
                                                                type="button"
                                                            ...
                                                            <button
                                                                onClick={ () => handleAllSIP( user.userFullData.userId ) }
                                                                type="button"
                                                                className="ti-btn rounded-full ti-btn-warning">
