...
const ConsultancyServiceList = () =>
{
    ...
    const handleAddService = () =>
    {
        ...
        navigate( `/consultancy/service/${ userId }/new-service` );
    };
    ...
    useEffect( () =>
    {
        ...
        axios
            .post( api + `/admin/consultancy/all-services`,
                {
...
export default ConsultancyServiceList;