                ...
                <nav className="main-header" aria-label="Global">
                    <div className="header-content">
                        ...
                        <div className="responsive-logo">
                            <Link className="responsive-logo-dark" to={ `${ import.meta.env.BASE_URL }hodashboardme` } aria-label="Brand">
                                <img src={ ALLImages( 'logo' ) } alt="logo" className="mx-auto" /></Link>
                            <Link className="responsive-logo-light" to={ `${ import.meta.env.BASE_URL }dashboard` } aria-label="Brand">
